...
#sudo apt-get install -y --no-install-recommends nvidia-cuda-toolkit-10-0 nvidia-driver-430
...
/usr/bin/itzo --version
# TODO: add defaultURL and version flag to itzo-launcher, use this flag here
